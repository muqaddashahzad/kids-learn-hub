  ...
  en: {
    ...
    categories: {
      ...
      vegetables: {
        ...
        Mushroom: 'Mushroom', Broccoli: 'Broccoli',
      },
      kitchen: {
        Spoon: 'Spoon', Cutlery: 'Cutlery', Knife: 'Knife', Plate: 'Plate', Cup: 'Cup',
        Glass: 'Glass', Pot: 'Pot', Bowl: 'Bowl', 'Baby Bottle': 'Baby Bottle', Pan: 'Pan',
      },
      home: {
        Bed: 'Bed', Chair: 'Chair', Door: 'Door', Window: 'Window', 'Light Bulb': 'Light Bulb',
      ...
      tools: {
        ...
        Toolbox: 'Toolbox', Axe: 'Axe', Paintbrush: 'Paintbrush', Ruler: 'Ruler',
        Clamp: 'Clamp', Ladder: 'Ladder', Bucket: 'Bucket', Magnet: 'Magnet',
  ...
  ur: {
    ...
    categories: {
      ...
      alphabet: {
        ...
        S: 'ستارہ', T: 'کچھوا', U: 'چھتری', V: 'وائلن', W: 'وہیل', X: 'ایکسرے',
        Y: 'یو یو', Z: 'زیبرا',
      },
      vegetables: {
        ...
        Mushroom: 'کھمبی', Broccoli: 'بروکلی',
      },
      kitchen: {
        Spoon: 'چمچ', Cutlery: 'چھری کانٹا', Knife: 'چھری', Plate: 'پلیٹ', Cup: 'کپ',
        Glass: 'گلاس', Pot: 'ہانڈی', Bowl: 'پیالہ', 'Baby Bottle': 'بچے کی بوتل', Pan: 'توا',
      },
      home: {
        Bed: 'بستر', Chair: 'کرسی', Door: 'دروازہ', Window: 'کھڑکی', 'Light Bulb': 'بلب',
      ...
      tools: {
        ...
        Toolbox: 'اوزار کا ڈبہ', Axe: 'کلہاڑی', Paintbrush: 'پینٹ برش', Ruler: 'فٹا',
        Clamp: 'کلیمپ', Ladder: 'سیڑھی', Bucket: 'بالٹی', Magnet: 'مقناطیس',
  ...
  hi: {
    ...
    categories: {
      ...
      vegetables: {
        ...
        Mushroom: 'मशरूम', Broccoli: 'ब्रोकली',
      },
      kitchen: {
        Spoon: 'चम्मच', Cutlery: 'छुरी काँटा', Knife: 'चाकू', Plate: 'प्लेट', Cup: 'कप',
        Glass: 'गिलास', Pot: 'बर्तन', Bowl: 'कटोरा', 'Baby Bottle': 'बच्चे की बोतल', Pan: 'तवा',
      },
      home: {
        Bed: 'बिस्तर', Chair: 'कुर्सी', Door: 'दरवाज़ा', Window: 'खिड़की', 'Light Bulb': 'बल्ब',
      ...
      tools: {
        ...
        Toolbox: 'औज़ार का डिब्बा', Axe: 'कुल्हाड़ी', Paintbrush: 'पेंट ब्रश', Ruler: 'पट्टी',
        Clamp: 'क्लैम्प', Ladder: 'सीढ़ी', Bucket: 'बाल्टी', Magnet: 'चुम्बक',
